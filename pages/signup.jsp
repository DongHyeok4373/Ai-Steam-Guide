...
<body>
    ...
    <header class="navbar">
        <div class="navbar-left">
            ...
            <div class="logo" onclick="location.href='<%= request.getContextPath() %>/pages/main.jsp'">AI Steam Guide</div>
        </div>
    ...
    <main>
        <section class="signup-section">
            ...
            <h2>환영합니다!</h2>
            <form class="signup-form" method="post" action="<%= request.getContextPath() %>/signupAction.jsp">
